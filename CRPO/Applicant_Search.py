...
class Excel_Data:
    def __init__(self):
        ...
        #Automation Tenant
        data = {"LoginName":"admin","Password":"SLWS-124","TenantAlias":"Automation","UserName":"admin"}
        #accenturetest Tenant
        # data = {"LoginName": "rpm", "Password": "Rpmuthu@123", "TenantAlias": "accenturetest", "UserName": "rpm"}
    ...
    # Read Excel Data
    # ------------------------------------------------------------------------------------------------------------------
        wb = xlrd.open_workbook('/home/vinod/SOFTWARE/PycharmProjects/InputFiles/'
    ...
    def all(self):
        ...
        for i in range(0,tot_len):
            ...
            if self.total_api_count  == self.Query_Result1:
                ...
                print self.query
            self.wb_result.save(
                '/home/vinod/Desktop/Output/'
                + self.__current_DateTime + '_Event_Search_with_Excepted_Matching.xls')
            # print statusCode, " -- ", b
