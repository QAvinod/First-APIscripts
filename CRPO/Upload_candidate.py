...
class UploadCandidate:
    ...
    def excel_data(self):
        ...
        # Excel Data Read
        # ----------------
        workbook = xlrd.open_workbook('/home/vinod/SOFTWARE/InputFiles/UploadCandidate/Candidate_Upload.xls')
    ...
    def output_excel(self, loop):
        ...
        # --------------------------------------------------------------------------------------------------------------
        self.rowsize += 1  # Row increment
        Obj.wb_Result.save('/home/vinod/Desktop/Output/API_UploadCandidates.xls')
