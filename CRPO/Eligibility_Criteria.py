...
class ECAutomation:
    def __init__(self):
        # rowsize is used for write excel
        ...
        self.data = {"LoginName": self.LoginName,
    ...
    # -------------------------------------------
    def Data_read(self):
        wb = xlrd.open_workbook('/home/vinod/SOFTWARE/InputFiles/EC/Final_EC_Configuration.xls')
    ...
    def excel_write(self, candidate_id, ex_aid, db_aid, ex_exp_status, db_status, db_mess, __style, event_id, job_id,
        ...
        ob.wb_Result.save(
            '/home/vinod/Desktop/Output/API_DB_EC_Verification(' + self.__current_DateTime + ').xls')
    # Class Invocation
