...
class scAutomation:
    def __init__(self):
        ...
        self.wb = xlrd.open_workbook(
            '/home/vinod/SOFTWARE/InputFiles/ShortlistingPanel/Assessment_Shortlisting2.xls')
...
# pending is get all applicant statuss, match excel, writeexcel
    ...
    def excel_write(self, candidate_id, xl_aid, xl_exp_status, db_status, db_mess, __style, event_id, job_id,testid,scid):
        ...
        ob.wb_Result.save('/home/vinod/Desktop/Output/API_Shortlisting_Panel(' + self.__current_DateTime + ').xls')
